                ...
                <div class="search-filters">
                    ...
                    <div>
                        ...
                        <ul class="categories-nav-list">
                            <li>
                                <a class="@if($category_id == null) active-cat-page @endif" href="{{ route('frontend.products')}}">الكل</a>
                            </li>
                            @foreach($categories as $category)
                                <li>
                                    <a class="@if($category->id == $category_id) active-cat-page @endif" href="{{ route('frontend.products',['category_id' => $category->id])}}">{{ $category->name }}</a>
                                </li>
                            @endforeach 
                        </ul> 
                    </div>
