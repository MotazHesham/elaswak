        ...
        <div class="container row">
            <div class="col-lg-3 signup-options-wrap">
                <ul class="signup-options">
                    ...
                    <li>
                        <a class="signup-active" href="{{ route('frontend.register.supplier')}}">
                            <div class="check-radio"></div>
                            مندوب
                        </a>
                    </li>
            ...
            <div class="col-lg-9 signup-form-wrap">
                <form class="signup-form" action="{{ route('frontend.register.supplier')}}" method="POST">
                    @csrf
                    <div class="form-line">
                    ...
                    <div class="form-line">
                        <div class="form-group">
                            <input type="text" placeholder="اسم الشركة" name="company_name" class="{{ $errors->has('company_name') ? 'is-invalid' : '' }}"   value="{{ old('company_name') }}" required/>
                    ...
                    <div class="form-line">
                        <div class="form-group">
                            <input type="text" placeholder="رقم السجل التجاري" name="commerical_num" class="{{ $errors->has('commerical_num') ? 'is-invalid' : '' }}"   value="{{ old('commerical_num') }}" required/>
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="تاريخ انتهاء السجل التجاري" name="commerical_expiry" class="date {{ $errors->has('commerical_expiry') ? 'is-invalid' : '' }}"   value="{{ old('commerical_expiry') }}" required/>
                    ...
                    <div class="form-line">
                        <div class="form-group">
                            <input type="text" placeholder="رقم الترخيص" name="licence_num" class="{{ $errors->has('licence_num') ? 'is-invalid' : '' }}"   value="{{ old('licence_num') }}" required/>
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="تاريح انتهاء رقم الترخيص" name="licence_expiry" class="date {{ $errors->has('licence_expiry') ? 'is-invalid' : '' }}"   value="{{ old('licence_expiry') }}" required/>
