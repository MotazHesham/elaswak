    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_us') ? 'is-invalid' : '' }}" name="about_us" id="about_us">{{ old('about_us') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('terms_and_conditions') ? 'is-invalid' : '' }}" name="terms_and_conditions" id="terms_and_conditions">{{ old('terms_and_conditions') }}</textarea>
