                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label class="required"
                            for="company_name">{{ trans('cruds.supplier.fields.company_name') }}</label>
                    ...
                    <div class="form-group col-md-3">
                        <label class="required"
                            for="commerical_num">{{ trans('cruds.supplier.fields.commerical_num') }}</label>
                    ...
                    <div class="form-group col-md-3">
                        <label class="required"
                            for="commerical_expiry">{{ trans('cruds.supplier.fields.commerical_expiry') }}</label>
                    ...
                    <div class="form-group col-md-3">
                        <label class="required"
                            for="licence_num">{{ trans('cruds.supplier.fields.licence_num') }}</label>
                    ...
                    <div class="form-group col-md-3">
                        <label class="required"
                            for="licence_expiry">{{ trans('cruds.supplier.fields.licence_expiry') }}</label>
