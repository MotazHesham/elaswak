                            ...
                            <tr data-entry-id="{{ $supplier->id }}">
                                ...
                                <td>
                                    <label class="c-switch c-switch-pill c-switch-success">
                                        <input onchange="update_approved(this)" value="{{ $supplier->user_id }}"
                                            type="checkbox" class="c-switch-input"
                                            {{ $supplier->user->approved ? 'checked' : null }}>
                                ...
                                <td>
                                    @if ($supplier->user->photo)
                                        <a href="{{ $supplier->user->photo->getUrl() }}" target="_blank"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Supplier:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
