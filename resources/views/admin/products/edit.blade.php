        ...
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $product->quantity) }}" step="0.01" min="1" required>
                ...
                <div class="form-group col-md-4">
                    <label class="required" for="supplier_id">{{ trans('cruds.product.fields.supplier') }}</label>
