        ...
        <form method="POST" action="{{ route("admin.delegates.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control select2 {{ $errors->has('district') ? 'is-invalid' : '' }}" name="district_id" id="district_id" required onchange="citries_of_district(this)">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('discount_code') ? 'is-invalid' : '' }}"  pattern="^\S+$" {{-- for none space --}}
                        type="text" name="discount_code" id="discount_code" value="{{ old('discount_code', '') }}" required>
