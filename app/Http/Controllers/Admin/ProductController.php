...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Product::with(['categories', 'tags', 'supplier'])->select(sprintf('%s.*', (new Product())->table));
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('categories', 'suppliers', 'tags'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('categories', 'tags', 'supplier');

        return view('admin.products.edit', compact('categories', 'product', 'suppliers', 'tags'));
    }
    ...
    public function show(Product $product)
    {
        ...
        $product->load('categories', 'tags', 'supplier', 'productProductRates', 'productsOffers');
