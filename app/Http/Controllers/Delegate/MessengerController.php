...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('delegate.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('delegate.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('delegate.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('delegate.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('delegate.messenger.reply', compact('topic', 'unreads'));
    }
